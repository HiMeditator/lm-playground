## Ref https://github.com/MarkTechStation/VideoCode/blob/main/MCP%E7%BB%88%E6%9E%81%E6%8C%87%E5%8D%97-%E8%BF%9B%E9%98%B6%E7%AF%87/weather/mcp_logger.py
    ...
    try:
        while True:
            ...
            try:
                ...
                log_file.write(f"[INPUT] {json.dumps(json_obj, ensure_ascii=False, indent=4)}\n")
            except:
...
def forward_and_log_stdout(target_stdout, proxy_stdout, log_file):
    ...
    try:
        while True:
            ...
            try:
                json_obj = json.loads(line_str)
                log_file.write(f"[OUTPUT] {json.dumps(json_obj, ensure_ascii=False, indent=4)}\n")
            except:
